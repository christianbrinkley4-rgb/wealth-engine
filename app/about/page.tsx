...
export const metadata: Metadata = {
  ...
  description:
    "Christian Brinkley is a licensed insurance agent in Greensboro, NC, finishing a master's in accounting at UNCG. He answers Medicare, retirement income, and life insurance questions for Triad households himself.",
  ...
  return (
    <main className="text-[var(--color-navy)]">
      <section className="bg-[var(--color-paper)] py-12 md:py-16">
        <div className="app-shell">
          <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-[2fr_3fr] md:gap-14">
            ...
            <div>
              <h1 className="text-[34px] leading-tight font-semibold tracking-tight text-[var(--color-navy)]">
                {AGENT.name}
              </h1>
              <p className="mt-2 text-[19px] font-medium text-[var(--color-navy)]">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className="inline-flex min-h-14 items-center justify-center gap-2 rounded-xl bg-[var(--color-navy)] px-6 text-[18px] font-semibold text-[var(--color-paper)]"
                >
                ...
                <a
                  ...
                  className="inline-flex min-h-14 items-center justify-center rounded-xl border-2 border-[var(--color-navy)] px-6 text-[18px] font-semibold text-[var(--color-navy)]"
                >
                  Email me
                </a>
              </div>
      ...
      <section className="border-t border-[rgba(15,34,65,0.08)] bg-white py-14">
        <div className="app-shell max-w-3xl space-y-7 text-[18px] leading-[1.85] text-[var(--color-navy)]">
          <p>
          ...
          <p>
            Most of what goes wrong with Medicare isn&apos;t someone picking the wrong plan.
            It&apos;s a seven-month enrollment window that quietly closed, or a six-month window for
          ...
          <p>
            So the deal here is simple: tell me what you&apos;re trying to work out, and I&apos;ll
            tell you the part that matters. If that turns into me helping you with coverage, good.
            If it turns into me telling you that you&apos;re already fine, or that you need an
            accountant rather than an agent, that&apos;s a good outcome too — and it happens
            regularly.
          </p>
          <p>
      ...
      <section className="border-t border-[rgba(15,34,65,0.08)] bg-[var(--color-paper)] py-14">
        <div className="app-shell max-w-3xl">
          <div className="rounded-xl border border-[rgba(15,34,65,0.12)] bg-white p-6 md:p-8">
            <h2 className="text-[22px] font-semibold text-[var(--color-navy)]">How I get paid</h2>
      ...
      <section className="border-t border-[rgba(15,34,65,0.08)] bg-white py-14">
        <div className="app-shell max-w-xl">
          <div className="rounded-xl border border-[rgba(15,34,65,0.1)] bg-white p-6 md:p-8">
            ...
            <ul className="mt-4 list-disc space-y-3 pl-5 text-[17px] leading-relaxed text-[var(--color-navy)]">
              <li>
      ...
      <section className="border-t border-[rgba(15,34,65,0.08)] bg-[var(--color-paper)] py-16">
        <div className="app-shell text-center">
          <h2 className="text-[26px] font-semibold text-[var(--color-navy)]">
            What are you trying to figure out?
          </h2>
          <p className="mx-auto mt-4 max-w-lg text-[17px] text-[var(--color-ink-muted)]">
            Two questions, and you&apos;ll have something useful before I ask for anything.
          </p>
          <Link
            href="/start"
            className="mt-8 inline-flex min-h-14 min-w-[240px] items-center justify-center rounded-xl bg-[var(--color-navy)] px-8 py-4 text-[17px] font-semibold text-[var(--color-paper)] transition-opacity hover:opacity-95"
          >
            Ask your question →
          </Link>
