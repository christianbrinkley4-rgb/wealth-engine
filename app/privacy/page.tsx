...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "What this site collects, who processes it, how long it is kept, and how to have it deleted. Information is never sold or passed to other agents.",
    ...
    <main className="bg-[var(--color-paper)] text-[var(--color-navy)]">
      <section className="measure-prose app-shell max-w-3xl py-12 md:py-16">
        ...
        <div className="text-18 mt-10 space-y-8 leading-[1.8]">
          ...
          <div>
            <h2 className="text-22 font-bold">Cookies and tracking</h2>
            <p className="mt-2 text-[var(--color-ink-muted)]">
              ...
              rather than your actual email address. You can limit this with your browser’s privacy
              settings or an ad blocker, and the form will still work.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-[var(--color-ink-muted)]">
              Inquiries that don’t turn into a working relationship are deleted after two years.
              Records for clients are kept as long as insurance and tax rules require, which is
              generally longer.
            </p>
          </div>
