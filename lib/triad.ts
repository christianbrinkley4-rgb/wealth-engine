 ...
 * different lists. That is the local fact a national mill will not have.
 *
 * Places past a honest half-hour — Clemmons, Asheboro proper, Lewisville —
...
export const TRIAD_CITIES: TriadCity[] = [
  {
    ...
    lifeIntro:
      "Greensboro is where I live, and it is where most of these conversations start: a kitchen table in Irving Park, a coffee shop near UNCG, or the phone if that’s easier. Life insurance is not sold by county. The local fact that matters is who is sitting across from you.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        q: "Do you meet in person in Greensboro?",
        a: "Yes. Your kitchen table, a coffee shop, or the phone. No cost and no obligation.",
      },
      {
    ...
    retirementIntro:
      "Greensboro households ask the same retirement question the national sites pretend to answer with an advisor match: what do I do with this 401(k), and will a withdrawal wreck something else. I can sit down and explain the four options and the Medicare timing. I cannot tell you how to invest it — I am not a registered investment adviser.",
    retirementDetail:
      "What I am is a licensed agent finishing a master’s in accounting at UNCG, which is why these conversations keep coming back to tax brackets and a premium set from a return two years old. If you worked for the state, Cone, or a private plan here, the paperwork is different. The Medicare trap is the same: a big conversion at 63 shows up on the first Part B bill at 65.",
    retirementFaq: [
      {
        q: "Are you a retirement advisor in Greensboro?",
        a: "No. I’m a licensed insurance agent, not a registered investment adviser. I explain 401(k) options, Social Security timing, and how withdrawals hit Medicare.",
      },
      {
        q: "Will you come to my house in Greensboro?",
        a: "Yes. Kitchen table or a coffee shop. No cost, no obligation.",
      },
      {
        q: "Can you tell me which funds to pick?",
        a: "No. That’s investment advice. What I can show you is what a withdrawal or Roth conversion does to your Medicare premium two years later.",
      },
    ],
  },
  {
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. Kitchen table, a coffee shop, or the phone. I’m licensed in North Carolina and I live in Greensboro — that’s a drive, not a call center.",
      },
      {
      ...
      },
      {
        ...
        a: "No. And I’ll tell you if you should leave it alone.",
      },
    ],
    retirementIntro:
      "High Point retirees get the same national ads Greensboro does. What I can do in person is narrower and more useful for the questions I actually get — an old 401(k), a withdrawal that will hit Medicare, Social Security timing. I am not a registered adviser, and I will not pretend otherwise.",
    retirementDetail:
    ...
    retirementFaq: [
      {
        ...
        a: "No. I’m a licensed insurance agent. I can explain how a 401(k) option or a Roth conversion lands on a Medicare premium. I cannot manage investments.",
      },
      {
        q: "Do you meet in High Point?",
        a: "Yes. I will sit down in High Point (about 22 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
  ...
  },
  {
    ...
    lifeIntro:
      "Winston-Salem is Forsyth County, about half an hour from where I live. That distance is the whole difference between this site and the national mills: I will drive it and sit down at your table. Wake Forest Baptist and Novant are where a lot of the group coverage in this city comes from, and that coverage usually leaves when the job does.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. About half an hour. Kitchen table, coffee shop, or the phone. No cost.",
      },
      {
      ...
      },
      {
        ...
        a: "No. A lot of these meetings end with me saying you’re already fine.",
      },
    ],
    retirementIntro:
      "Winston-Salem searches for retirement advisors the same way Greensboro does, and the ads all sell a match with a stranger. I will sit down in Forsyth and explain what an old 401(k) actually does. I will not manage the money. I am not a registered investment adviser.",
    retirementDetail:
    ...
    retirementFaq: [
      ...
      },
      {
        ...
        a: "Yes. Kitchen table or the phone. I’m licensed in North Carolina.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Kernersville sits on the Guilford–Forsyth line, about half an hour west of downtown Greensboro. That is the whole Medicare story here. Two houses on the same road can be shopping from different Advantage lists because one is in Forsyth and the other is in Guilford. A national call center will ask for your ZIP and guess. I would rather look at the county.",
    localDetail:
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. About half an hour from downtown Greensboro. Kitchen table or the phone.",
      },
      {
    ...
    lifeIntro:
      "Kernersville is a kitchen-table town — close enough that I drive it the same as Greensboro, and far enough that a national mill treats it as a ZIP to sell. Group coverage here often came with a job in Winston-Salem or at the airport corridor, and it usually ends when the commute does.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. About 30 minutes from downtown Greensboro. No cost.",
      },
      {
        q: "Does the county line matter for life insurance?",
        a: "No. It matters a great deal for Medicare Advantage. Don’t mix the two.",
      },
      {
    ...
    retirementDetail:
      "If you live on the Guilford side, a Roth conversion hits the same Medicare trap as Greensboro. If you live on the Forsyth side, the Advantage list is different and the trap is the same. The conversion does not care which county you are in. The plan list does.",
    retirementFaq: [
      {
        q: "Are you a financial advisor in Kernersville?",
        a: "No. Licensed insurance agent. 401(k) options and Medicare timing, not investment management.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Kernersville (about 28 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
  ...
  },
  {
    ...
    localDetail:
      "The plan has to include the Greensboro doctors you actually use. Living in Summerfield does not change the county list. It does change how far you are willing to drive for a specialist, and that is the conversation I would rather have at the table than on a script.",
    nearby: ["Oak Ridge", "Stokesdale", "Browns Summit", "Greensboro"],
    faq: [
      {
        q: "Are Summerfield Medicare plans different from Greensboro?",
        a: "No. Guilford County. Same list. Your doctors and prescriptions still decide which one fits.",
      },
      {
        q: "Will you come to Summerfield?",
        a: "Yes. About twenty minutes north. Kitchen table or the phone.",
      },
      {
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Summerfield (about 22 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
      ...
      {
        q: "Is there a charge?",
        a: "No. Sitting down in Summerfield costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementFaq: [
      {
        ...
        a: "No. I can explain 401(k) options and Medicare timing. Investment management is a different license.",
      },
      {
  ...
  },
  {
    ...
    localDetail:
      "Guilford College Road households often have a primary doctor in one city and a specialist in the other. The plan has to cover both, by name, for the year coverage starts. I would rather check that at your table than assume Jamestown works like Greensboro because it shares a county.",
    nearby: ["High Point", "Greensboro", "Pleasant Garden", "Archdale"],
    faq: [
      {
        q: "Is Jamestown on the Greensboro Medicare list?",
        a: "Yes. Guilford County. Same Advantage and Part D list as Greensboro and most of High Point.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes. About twenty minutes. Kitchen table or the phone.",
      },
    ],
    lifeIntro:
      "Jamestown is close enough that I treat it like a Greensboro neighborhood with a High Point hospital. Life insurance here is usually a policy bought when someone first settled between the two cities. I’ll read it at the table. No call center.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. Twenty minutes from downtown Greensboro. No cost.",
      },
      {
      ...
      },
      {
        ...
        a: "No. Sitting down in Jamestown costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementDetail:
      "If you still work in one city and live in Jamestown, the years before 65 are when a large withdrawal is most likely to show up on the first Medicare bill. That’s the conversation, not a product pitch.",
    retirementFaq: [
      {
        q: "Are you a retirement advisor in Jamestown?",
        a: "No. Licensed agent. Education on 401(k) options and Medicare timing.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Jamestown (about 20 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
        q: "Does living between Greensboro and High Point change the 401(k) rules?",
        a: "No. It can change which Medicare Advantage list you’re on if you were on a county edge — Jamestown itself is Guilford.",
      },
    ],
  },
  {
    ...
    faq: [
      {
        ...
        a: "No. Oak Ridge is Guilford County, so the Advantage and Part D list matches Greensboro. Your doctors and prescriptions still decide which plan fits.",
      },
      {
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Oak Ridge (about 20 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
      ...
      {
        q: "Any fee?",
        a: "No. Sitting down in Oak Ridge costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementFaq: [
      {
        ...
        a: "No. Licensed insurance agent. Medicare timing and 401(k) options, not investment advice.",
      },
      {
  ...
  },
  {
    ...
    localDetail:
      "The hospital you use may be in Guilford. The plan list is Randolph. That split is how people enroll in something that looks right on a High Point mailer and does not include the doctors they actually see. I would rather check the county first, then the doctors, at your table.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "That’s the check. Randolph plans may or may not include a specific High Point practice. We look it up by name for the year coverage starts.",
      },
      {
        q: "Will you sit down in Archdale?",
        a: "Yes. About twenty-five minutes from downtown Greensboro. Kitchen table or the phone.",
      },
    ],
    lifeIntro:
      "Archdale is a Randolph County kitchen table twenty-five minutes from Greensboro. Life insurance does not follow the county line that just changed your Medicare list. I’ll drive it and read the policy with you.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Archdale (about 25 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
        q: "Does Randolph vs Guilford matter for life insurance?",
        a: "No. It matters for Medicare Advantage. Don’t mix them.",
      },
      {
        q: "Do I have to buy?",
        a: "No. Sitting down in Archdale costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementDetail:
      "A rollover is the same paperwork as in Greensboro. The Advantage list is not. If you are turning 65, look at both in the same meeting. That’s why I would rather be at the table than on a national matching site.",
    retirementFaq: [
      {
        q: "Are you a financial advisor in Archdale?",
        a: "No. I explain 401(k) options and how withdrawals hit Medicare.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Archdale (about 25 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
    ...
    faq: [
      {
        ...
        a: "No. Thomasville is Davidson County. Most of High Point is Guilford. Different lists.",
      },
      {
        q: "Will you drive to Thomasville?",
        a: "Yes. About half an hour. That’s the edge of where I sit down in person.",
      },
      {
        q: "Can a Davidson plan include High Point Medical Center?",
        a: "Sometimes. We check the specific plan and the year coverage starts. I will not guess from a website table.",
      },
    ],
    lifeIntro:
      "Thomasville is a half-hour drive and a Davidson County kitchen table. Life insurance here often came with furniture-industry work that has since changed names. I’ll read what you still have. No call center.",
    lifeDetail:
      "Group coverage from a High Point or Thomasville employer usually ends at retirement. Permanent coverage bought at a kitchen table twenty years ago is the other file. Bring both if you have them.",
    lifeFaq: [
      {
      ...
      },
      {
        ...
        a: "No. It changes Medicare Advantage. Different problem.",
      },
      {
        q: "Fee?",
        a: "No. Sitting down in Thomasville costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
      "Thomasville is Davidson County for Medicare and often a High Point 401(k). I can explain the four options and the premium trap. I cannot manage the account. I am not a registered adviser.",
    retirementDetail:
    ...
    retirementFaq: [
      {
        ...
        a: "No. Licensed insurance agent. 401(k) options and Medicare timing only.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. About half an hour. Kitchen table or the phone.",
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. Under twenty minutes from downtown. Kitchen table or the phone.",
      },
      {
    ...
    lifeIntro:
      "Pleasant Garden is a short drive south and a Guilford County kitchen table. I’ll sit down here the same as in town. Life insurance is not a different product because the address says Pleasant Garden.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Pleasant Garden (about 18 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
      ...
      {
        q: "Any obligation?",
        a: "No. Sitting down in Pleasant Garden costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementDetail:
      "Being south of the city does not change IRMAA. It does mean I would rather sit down here than ask you to drive in for a conversation that takes twenty minutes.",
    retirementFaq: [
      {
        q: "Are you a retirement planner in Pleasant Garden?",
        a: "No. Licensed agent. Education, not investment advice.",
      },
      {
        q: "Will you come here?",
        a: "Yes. I will sit down in Pleasant Garden (about 18 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. About twenty minutes east. Kitchen table or the phone.",
      },
    ],
    lifeIntro:
      "Whitsett is a Guilford County kitchen table on the way to Burlington. I’ll drive it. Life insurance here is often a Greensboro job policy plus something bought when the house went up. I’ll read both.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Whitsett (about 20 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
      ...
      {
        q: "Fee?",
        a: "No. Sitting down in Whitsett costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementFaq: [
      {
        ...
        a: "No. Licensed agent. 401(k) options and Medicare timing.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Whitsett (about 20 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
  ...
  },
  {
    ...
    faq: [
      {
        ...
        a: "Yes. McLeansville is Guilford County — the same Advantage and Part D list Greensboro shops from.",
      },
      {
        q: "Will you come to McLeansville?",
        a: "Yes. About fifteen minutes. Kitchen table or the phone.",
      },
      {
    ...
    lifeIntro:
      "McLeansville is a Guilford County kitchen table fifteen minutes from mine. I’ll sit down here. Life insurance is the same question as in town: how many more years the money needs to be there.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in McLeansville (about 15 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
        q: "Work coverage through Greensboro — keep it?",
        a: "Find out what happens when you leave. That’s the review.",
      },
      {
        q: "Obligation?",
        a: "No. Sitting down in McLeansville costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
      "McLeansville is Guilford Medicare and usually a Greensboro 401(k). I explain the four options and the premium trap. I am not a registered adviser.",
    retirementDetail:
      "There is no special McLeansville retirement product. There is a kitchen table fifteen minutes away and a Medicare timing question most matching sites will not mention.",
    retirementFaq: [
      {
        q: "Retirement advisor in McLeansville?",
        a: "No. I am a licensed insurance agent, not a registered investment adviser. In McLeansville I explain 401(k) options and Medicare timing — not which funds to hold.",
      },
      {
        q: "Will you come out?",
        a: "Yes. I will sit down in McLeansville (about 15 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Then we check whether a Guilford plan includes that practice. Don’t assume it because you drive 29 every week.",
      },
    ],
    lifeIntro:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Browns Summit (about 20 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
      ...
      {
        q: "Must we buy?",
        a: "No. Sitting down in Browns Summit costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementFaq: [
      {
        ...
        a: "No. I am a licensed insurance agent, not a registered investment adviser. In Browns Summit I explain 401(k) options and Medicare timing — not which funds to hold.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Browns Summit (about 20 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
  ...
  },
  {
    ...
    localDetail:
      "People here use Cone in Greensboro, Alamance Regional, or both. Elon is next door. I would rather look at the tax bill and the doctors’ names at your kitchen table than let a ZIP code decide it.",
    ...
    lifeIntro:
      "Gibsonville is a kitchen table on the Guilford–Alamance line. Life insurance ignores that line. I’ll still drive it, because the person who reads the policy should not be a stranger who bought a ZIP.",
    lifeDetail:
    ...
    lifeFaq: [
      ...
      {
        q: "Fee?",
        a: "No. Sitting down in Gibsonville costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementFaq: [
      ...
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Gibsonville (about 22 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Elon is Alamance County, about half an hour east of downtown Greensboro past Gibsonville. Medicare Advantage here is not the Guilford list. It is the Alamance list, the same one Burlington sees. University town, Cone Health hospital in Burlington, and a kitchen table I can reach in person.",
    localDetail:
    ...
    faq: [
      {
        ...
        a: "No. Elon is Alamance County. Greensboro is Guilford. Different lists.",
      },
      {
      ...
      },
      {
        ...
        a: "Then we check whether an Alamance plan includes that practice. Don’t assume it.",
      },
    ],
    lifeIntro:
    ...
    lifeFaq: [
      ...
      {
        q: "Must we buy?",
        a: "No. Sitting down in Elon costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementDetail:
      "The Advantage list is Alamance. The IRMAA math is the same as Greensboro. Sit down with both. That’s the local version of a retirement conversation, not a product pitch.",
    retirementFaq: [
      {
        q: "Financial advisor in Elon?",
        a: "No. I am a licensed insurance agent, not a registered investment adviser. In Elon I explain 401(k) options and Medicare timing — not which funds to hold.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Elon (about 28 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
  ...
  },
  {
    ...
    faq: [
      {
        ...
        a: "Yes. About half an hour on I-40 in ordinary traffic. That’s the eastern edge of kitchen-table visits.",
      },
      {
        q: "Are Burlington Medicare plans the same as Greensboro?",
        a: "No. Alamance vs Guilford. Different lists, even though Alamance Regional is Cone Health.",
      },
      {
        q: "Will you sit down in Burlington?",
        a: "Yes. I will sit down in Burlington (about 30 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
    ],
    lifeIntro:
      "Burlington is a half-hour east and a kitchen table I will drive to. Life insurance here often came with mill, hospital, or lab work. I’ll read what you have. No call center.",
    lifeDetail:
    ...
    lifeFaq: [
      ...
      {
        q: "Fee?",
        a: "No. Sitting down in Burlington costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementDetail:
      "Cone Health on the hospital does not mean Guilford Advantage. Confirm Alamance, then look at the conversion timing. That’s the meeting.",
    retirementFaq: [
      {
        q: "Retirement advisor in Burlington?",
        a: "No. I am a licensed insurance agent, not a registered investment adviser. In Burlington I explain 401(k) options and Medicare timing — not which funds to hold.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Burlington (about 30 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
  ...
  },
  {
    ...
    localDetail:
      "Doctors are usually Cone in Greensboro. The drive is longer than Oak Ridge and still inside the kitchen-table radius. I sit down here. I do not treat Stokesdale as too far because it isn’t Greensboro proper.",
    ...
    lifeIntro:
      "Stokesdale is a Guilford County kitchen table I will drive to. Life insurance here is often a policy bought when someone wanted land and kept a Greensboro job. I’ll read it on site.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Stokesdale (about 28 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
        q: "Too far?",
        a: "No. Stokesdale is about 28 minutes from downtown Greensboro, inside the kitchen-table radius I actually claim.",
      },
      {
        q: "Obligation?",
        a: "No. Sitting down in Stokesdale costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementFaq: [
      {
        ...
        a: "No. I am a licensed insurance agent, not a registered investment adviser. In Stokesdale I explain 401(k) options and Medicare timing — not which funds to hold.",
      },
      {
        q: "Will you come here?",
        a: "Yes. I will sit down in Stokesdale (about 28 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
    ...
    faq: [
      {
        ...
        a: "Yes. Colfax is Guilford County — the same Advantage and Part D list Greensboro shops from.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes. Under twenty minutes. Kitchen table or the phone.",
      },
    ],
    lifeIntro:
      "Colfax is I-40, the airport, and a Guilford County kitchen table. I’ll sit down here. Life insurance is usually Greensboro or High Point job coverage plus a policy for the house.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Colfax (about 18 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
      ...
      {
        q: "Fee?",
        a: "No. Sitting down in Colfax costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
      "Colfax is Guilford Medicare and often a 401(k) from the I-40 corridor. I explain options and the premium trap. I am not a registered adviser.",
    retirementDetail:
    ...
    retirementFaq: [
      {
        ...
        a: "No. I am a licensed insurance agent, not a registered investment adviser. In Colfax I explain 401(k) options and Medicare timing — not which funds to hold.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Colfax (about 18 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
  ...
  },
  {
    ...
    faq: [
      {
        ...
        a: "Yes. About half an hour on US-29. That’s the northern edge of in-person meetings.",
      },
      {
        q: "Same Medicare plans as Greensboro?",
        a: "No. Rockingham County vs Guilford. Different lists.",
      },
      {
        q: "Will you sit down in Reidsville?",
        a: "Yes. I will sit down in Reidsville (about 30 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
    ],
    lifeIntro:
    ...
    lifeFaq: [
      ...
      {
        q: "Too far?",
        a: "No. Reidsville is about 30 minutes from downtown Greensboro, inside the kitchen-table radius I actually claim.",
      },
      {
        q: "Fee?",
        a: "No. Sitting down in Reidsville costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
    ...
    retirementFaq: [
      {
        ...
        a: "No. I am a licensed insurance agent, not a registered investment adviser. In Reidsville I explain 401(k) options and Medicare timing — not which funds to hold.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Reidsville (about 30 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
        ...
        a: "Then we check whether a Rockingham plan includes those doctors. Don’t assume it.",
      },
    ],
  },
  {
    ...
    localDetail:
      "Some people still use Cone in Greensboro. Some use Randolph Health. The plan list is Randolph. Pleasant Garden, twenty minutes north, is Guilford. That is the kind of local split a call center will not have, and it is why the page exists.",
    nearby: ["Pleasant Garden", "Archdale", "Thomasville"],
    faq: [
      {
        q: "Do you serve Asheboro?",
        a: "Asheboro proper is about 50 minutes — outside the kitchen-table radius. Randleman is the south edge I will drive. Phone is always fine farther out.",
      },
      {
        q: "Same Medicare plans as Greensboro?",
        a: "No. Randleman is Randolph County. Greensboro is Guilford. Those are different Advantage lists.",
      },
      {
    ...
    lifeIntro:
      "Randleman is the south edge of in-person visits. I’ll sit down there. Life insurance does not follow the Randolph line. Asheboro is farther than I claim for a kitchen table; this town is not.",
    lifeDetail:
    ...
    lifeFaq: [
      {
        ...
        a: "Yes. I will sit down in Randleman (about 28 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
      },
      {
        q: "What about Asheboro?",
        a: "That’s past a honest half-hour. We can talk on the phone. I won’t pretend it’s the same drive.",
      },
      {
        q: "Fee?",
        a: "No. Sitting down in Randleman costs nothing, and you do not have to buy or enroll afterward.",
      },
    ],
    retirementIntro:
      "Randleman is Randolph County for Medicare and the south edge of kitchen-table visits. I explain 401(k) options and Medicare timing. I am not a registered adviser. I will not claim Asheboro as a local market.",
    retirementDetail:
    ...
    retirementFaq: [
      {
        ...
        a: "No. I am a licensed insurance agent, not a registered investment adviser. In Randleman I explain 401(k) options and Medicare timing — not which funds to hold.",
      },
      {
        q: "Will you meet here?",
        a: "Yes. I will sit down in Randleman (about 28 minutes from downtown Greensboro) — kitchen table, coffee shop, or the phone. No cost.",
...
export function placeCheckBeat(city: TriadCity): string {
  ...
  const nextDoor =
    contrasts.length > 0
      ...
      : ` Nearby ${city.nearby[0]} is still a kitchen-table stop; people search the town name, not the county.`;
