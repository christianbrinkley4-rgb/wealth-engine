# Profile copy for LinkedIn, Facebook, Nextdoor, and Google

Everything below is written to do one job: get someone in the Triad who is
approaching 65 onto christianbrinkleync.com and into a consultation request.

Upline cleared the public business copy on 2026-09-18: fine as long as
Bankers Life is not mentioned. Facebook and Nextdoor below follow that.
LinkedIn is the career profile and does name the employer; keep it that way.
The website uses the independent Maps listing titled Christian Brinkley.
Do not mention Bankers Life on the public site.

---

## Google Business Profile / Maps

This is the listing the website links to:
...
Do not add `agents.bankerslife.com`, `branches.bankerslife.com`, or a Bankers
Life Nextdoor page to the website profiles.
...
Profile URL is https://www.linkedin.com/in/christianbrinkley — clean, and
worth keeping. This stays the accounting-career profile. Do not turn it into
a Medicare business page.
...
| Website  | None                                                                                                                             | Must be `https://christianbrinkleync.com` this week                                   |
...
The Page already exists. Do not create another one.
...
| Website      | https://christianbrinkleync.com                                               | already correct — leave it                                                                            |

### Intro / Bio — paste this

```
Licensed insurance agent in Greensboro. I help Triad families figure out Medicare at 65. Not a call center — I'll sit down at your kitchen table. christianbrinkleync.com
```
...
The thing that actually works here is answering Medicare questions neighbors
already ask, without pitching. Four or five helpful answers and people start
tagging you when someone else asks.

---

# What else to create, in the order I'd do it
...
6. **Apple Business Connect** — https://businessconnect.apple.com. Free.
   Decides what Siri and iPhone Maps say about you. A large share of
   65-year-olds use iPhones, and this is the listing nobody's competitors
   bother with.
7. **Yelp** — free claim. Ranks well for "insurance agent Greensboro" and is
   read by the assistants. Seniors do check it.

## Worth real money

8. **Greensboro Chamber of Commerce.** A paid membership, and the member
   directory link is one of the few genuinely local, genuinely followed links
   available to you. This is the single best answer to your zero-backlinks
   problem.
9. **Better Business Bureau accreditation.** Costs a few hundred a year. The
   BBB badge carries disproportionate weight with the over-65 demographic, more
   than it does with anyone younger.

## The two highest-leverage things for AI specifically

10. **A YouTube channel.** Four or five phone-shot videos, two minutes each,
   answering one question: "What happens if I miss my Medicare window?" "Can I
   keep my doctor?" YouTube is the second-largest search engine, Google
   surfaces video for these queries, and assistants cite transcripts. It also
   solves your no-social-proof problem — people trust a face.
11. **Reddit, carefully.** r/medicare gets these questions daily, and AI models
    weight Reddit heavily in training and in search. Answering genuinely and
    well, with a profile that says who you are, builds the kind of reputation
    assistants repeat. **Read each subreddit's self-promotion rules first** —
    dropping links gets you banned, and a ban is permanent. Be useful; let people
    click your profile.

## Skip

- Paid "500 directory submission" packages. Google discounts them.
- Insurance lead directories that require handing over prospects. A link is not
  worth contradicting the one promise your whole site makes.
- Twitter/X and Instagram. Your buyers are not there in numbers that justify
  the work, and a dead account looks worse than none.
